...
public class Main extends Application {
	...
	public static ResourceBundle getBundle() {
		if (bundle == null) {
			try {
				bundle = ResourceBundle.getBundle("client.application.text", Locale.getDefault());
			} catch (Exception e) {
	...
	public static void setBundle(Locale loc) {
		Main.bundle = ResourceBundle.getBundle("client.application.text", loc);
	}
	...
	private Pane createMainScene(PagedTable mainTable, TableControler mainControler) {
		...
		VBox box = new VBox();
		Pane tools = createMainTool(mainControler);
	...
	private Pane createMainTool(TableControler mainControler) {
		...
		tools.getChildren().addAll(addTool, findAndRemoveTool);
		return tools;
	}
